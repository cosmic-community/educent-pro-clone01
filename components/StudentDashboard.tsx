...
import type { Reward, SyllabusItem, Query, Notification, User } from '@/types'
...
export default function StudentDashboard({ 
  ...
  useEffect(() => {
    ...
    const streak = calculateAttendanceStreak(attendance, user.metadata?.username || '')
  ...
  const completedTopics = syllabusItems.filter(item => item.metadata?.completed).length
